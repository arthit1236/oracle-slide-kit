...
- Stage 2: Outline (structure before writing)
- Stage 3: Copywriting (tone, voice, length-per-slide rules)
- Stage 4: Visual direction handoff to Prism
- Stage 5: Review + iteration loop
- Stage 6: Final QA (via SOP-SLIDE-001)
- Stage 7: Delivery (file format, naming, delivery path)
